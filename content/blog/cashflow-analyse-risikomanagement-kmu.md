---
title: 'Was ist eine Cashflow-Analyse – und wie hängt sie mit Risikomanagement für KMU zusammen?'
seo_title: 'Cashflow-Analyse & Liquiditätsrisiko'
primary_keyword: cashflow analyse kmu
secondary_keywords:
  - liquiditätsrisiko kmu
  - liquiditätsengpass
...
hero_image: img/blog/cashflow-analyse-risikomanagement-kmu-hero.png
hero_alt: Unternehmer prüft Liquiditätsentwicklung und Cashflow-Kennzahlen auf einem Dashboard im Büro
draft: false
related_slugs:
  - what-is-risk-management
  - risikomanagement-beratung-kmu-anbieter
  - externe-risikofaktoren-fur-kmu-8-einflussfaktoren-die-ihr-unternehmen-bedrohen
  - zeit-als-risikofaktor-unternehmer-risikomanagement
faq:
  - question: Was ist der Unterschied zwischen Cashflow und Gewinn?
    answer: "Der Gewinn ist eine bilanzielle Größe und kann positiv sein, obwohl auf dem Konto kein Geld liegt – etwa weil Kunden noch nicht gezahlt haben. Der Cashflow misst die tatsächlichen Zahlungsströme: Wie viel Geld fließt real hinein und hinaus? Ein Unternehmen kann profitabel sein und trotzdem zahlungsunfähig werden."
  - question: Was ist ein Liquiditätsrisiko?
    answer: Ein Liquiditätsrisiko ist die Gefahr, laufende Zahlungen wie Löhne, Miete oder Lieferantenrechnungen kurzfristig nicht leisten zu können – obwohl das Unternehmen mittelfristig gesund ist. Es entsteht oft durch verspätete Zahlungen, den Wegfall eines Großkunden oder saisonale Schwankungen.
  - question: Welche Kennzahlen zeigen ein Liquiditätsrisiko früh an?
    answer: "Drei Signale sind besonders aussagekräftig: die Reichweite der liquiden Mittel (wie viele Monate Fixkosten decken die Rücklagen?), die durchschnittliche Debitorenlaufzeit (wie lange dauert es, bis Kunden zahlen?) und die Kundenkonzentration (welcher Umsatzanteil hängt an einem einzigen Kunden?)."
  - question: Wie bewertet Beraterium Liquiditätsrisiko?
    answer: Beraterium bewertet Liquiditätsrisiko wie jedes andere Risiko in Euro – als konkreten Schaden mit Eintrittswahrscheinlichkeit – statt mit einer Kennzahlen-Ampel. So wird vergleichbar, ob der Ausfall eines Großkunden oder eine verlängerte Zahlungsfrist das größere Risiko ist.
  - question: Wie oft sollte ein KMU eine Cashflow-Analyse machen?
    answer: Für die laufende Steuerung empfiehlt sich eine rollierende Liquiditätsvorschau, die monatlich aktualisiert wird. Eine tiefere Cashflow- und Risikoanalyse lohnt sich zusätzlich einmal jährlich sowie vor größeren Entscheidungen wie Investitionen, Einstellungen oder einer Nachfolge.
